...
export const projects = [
  ...
  {
    title: "URL Shortener",
    description: "A full-stack URL shortening service with custom alias support, analytics tracking, and QR code generation. Built with Node.js backend and modern frontend framework.",
    techStack: ["HTML", "Node.js", "Express", "MongoDB",],
    githubUrl: "https://github.com/Fataharul/url-shortner",
    liveUrl: null,
  },
  {
    title: "Green Earth",
